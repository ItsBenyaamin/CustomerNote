...
@Composable
fun InsertScreen(action: (InsertScreenActions) -> Unit) {
                ...
                CenteredClickableIcon(
                    ...
                    onClick = {
                        ...
                        if (
                            ...
                            val note = Note(0, name.value, phoneNumber.value, date.value, description.value)
                            action(InsertScreenActions.Save(note))
                        }else {
            ...
            navigationIcon = {
                CenteredClickableIcon(
                    modifier = Modifier
                        .size(32.dp)
                        .padding(4.dp),
                    onClick = { action(InsertScreenActions.Back) },
